  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-emerald-500/30 overflow-x-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center py-32 px-6 overflow-hidden min-h-[85vh]">
        ...
        <div className="absolute inset-0 opacity-20 pointer-events-none dark:opacity-40 opacity-10">
          <div className="absolute bottom-0 w-full h-[60%] bg-gradient-to-t from-background to-transparent mountain-mask" />
          <svg className="absolute bottom-0 w-full" viewBox="0 0 1440 320" preserveAspectRatio="none">
            <path fill="currentColor" className="text-slate-800 dark:text-slate-600" fillOpacity="1" d="M0,224L48,213.3C96,203,192,181,288,181.3C384,181,480,203,576,224C672,245,768,267,864,250.7C960,235,1056,181,1152,165.3C1248,149,1344,171,1392,181.3L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
          </svg>
        </div>
        ...
        <div className="max-w-screen-2xl mx-auto text-center relative z-10">
          ...
          <div className="grid grid-cols-1 gap-16 items-start max-w-4xl mx-auto">
            <div className="flex flex-col gap-6 p-1 rounded-3xl bg-gradient-to-b from-emerald-500/10 to-transparent">
              <div className="flex items-center justify-between px-6 pt-4">
                <h3 className="text-sm font-black text-emerald-500 dark:text-emerald-400 uppercase tracking-[0.3em]">Peak Runner</h3>
                <span className="text-[10px] text-muted-foreground font-mono">STATUS: OPTIMAL</span>
              </div>
              <PipelineRunner />
            </div>
            <div className="flex flex-col gap-6 p-1 rounded-3xl bg-gradient-to-b from-trail-gold/10 to-transparent">
              <div className="flex items-center justify-between px-6 pt-4">
                ...
                <span className="text-[10px] text-muted-foreground font-mono">STATUS: ACTIVE</span>
              </div>
              <SnakeGame />
            </div>
        ...
        <div className="grid gap-8">
          {experiences.map((exp, i) => (
            <div key={i} className="glass glass-hover p-10 rounded-3xl group transition-all duration-700 hover:border-emerald-500/30 relative overflow-hidden">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-6 text-muted-foreground relative z-10">
      ...
      <section className="py-24 px-6 bg-secondary/50 dark:bg-slate-900/10 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {certifications.map((cert, i) => (
              <div key={i} className="glass glass-hover p-8 rounded-3xl flex items-center gap-8 group">
                <div className="w-20 h-20 rounded-2xl bg-white/50 dark:bg-white/5 flex items-center justify-center p-4 group-hover:scale-110 group-hover:bg-white/80 dark:group-hover:bg-white/10 transition-all duration-500 shadow-inner">
              ...
              <div className="flex flex-col md:flex-row justify-between gap-4 relative z-10">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4 text-xs text-muted-foreground font-mono">
                    <span className="px-3 py-1 bg-secondary rounded-lg">{pub.year}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Footer */}
      <footer className="py-24 px-6 border-t border-border text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center gap-8">
          ...
          <p className="text-muted-foreground text-[10px] font-bold uppercase tracking-[0.5em] leading-[2]">
